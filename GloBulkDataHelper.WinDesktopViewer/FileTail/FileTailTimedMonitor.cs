...
{
    public class FileTailTimedMonitor : FileTailMonitor, IFileTailTimedMonitor
    {
        private readonly Timer _timer;
        private readonly FileSystemWatcher _watcher;
        private TimeSpan _timerInterval;

        public FileTailTimedMonitor(string filePath, Encoding encoding, TimeSpan interval)
